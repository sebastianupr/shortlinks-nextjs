...
export default function IlustrationWorking (props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={733} height={482} {...props}>
      <defs>
        ...
        <linearGradient
          ...
          y2="153.095%"
        >
          <stop offset="0%" stopColor="#362958" stopOpacity={0.501} />
      ...
      <g fill="none">
        ...
        <ellipse cx={54.5} cy={395} fill="url(#prefix__o)" rx={32.5} ry={6} />
        <path
          fill="#2BD0D0"
